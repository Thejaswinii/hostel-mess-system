...
$sql_check = "SELECT * FROM inventory_boys WHERE year = '$year' AND month = '$month' AND week = '$week'";
$result = $conn->query($sql_check);

if ($result->num_rows > 0) {
    // Update the existing record
    $sql_update = "UPDATE inventory_boys 
    ...
    // Insert a new record
    $sql_insert = "INSERT INTO inventory_boys (year, month, week, vegetables, oil, milk, gas, rice, wheat_flour, egg, grams)
...
$sql_monthly = "INSERT INTO monthly_inventory_total_boys (year, month, total)
